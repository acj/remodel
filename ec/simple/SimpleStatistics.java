...
public class SimpleStatistics extends Statistics implements SteadyStateStatisticsForm
    ...
    /** The best individual we've found so far along with the runner-up */
    public Individual[] best_of_run;
    public Individual[] next_best_of_run;
    ...
    public void postInitializationStatistics(final EvolutionState state)
        ...
        next_best_of_run = new Individual[state.population.subpops.length];
        }
    ...
    public void postEvaluationStatistics(final EvolutionState state)
        ...
        for(int x=0;x<state.population.subpops.length;x++)
        {
            ...
            } else if (next_best_of_run[x] == null || best_i[x].fitness.betterThan(next_best_of_run[x].fitness)) {
            	next_best_of_run[x] = (Individual)(best_i[x].clone());
            }
        }
