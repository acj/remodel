 ...
 *
 */
public class OperNode extends GPNode {
	...
	public OperNode clone() {
		OperNode vn = (OperNode)(super.cloneReplacing());
		vn.ag = null;
	...
	public boolean nodeEquals(GPNode node) {
        if (((OperNode)node).ag.GetGraphId() == ag.GetGraphId() &&
        		((OperNode)node).GetName() == GetName()) {
        	return true;
        } else {
        	return false;
        }
	...
	public void eval(EvolutionState state, int thread, GPData input,
		...
		vertexName = ag.GetRandomVertex(AnnotatedVertex.VertexType.OPERATION).toString();
		rd.name = vertexName;
	}

	public String toString() {
		return "OperNode<" + vertexName + ">";
	}
