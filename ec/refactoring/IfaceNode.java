 ...
 *
 */
public class IfaceNode extends GPNode {
	...
	public IfaceNode clone() {
		IfaceNode vn = (IfaceNode)(super.cloneReplacing());
		vn.ag = null;
	...
	public boolean nodeEquals(GPNode node) {
        if (((IfaceNode)node).ag.GetGraphId() == ag.GetGraphId() &&
        		((IfaceNode)node).GetName() == GetName()) {
        	return true;
        } else {
        	return false;
        }
	...
	public void eval(EvolutionState state, int thread, GPData input,
		...
		vertexName = ag.GetRandomVertex(AnnotatedVertex.VertexType.INTERFACE).toString();
		rd.name = vertexName;
	}

	public String toString() {
		return "IfaceNode<" + vertexName + ">";
	}
