...
public class RefactorFitness extends Fitness
    {
    ...
    public Parameter defaultBase()
        {
        return RefactorDefaults.base().push(P_FITNESS);
        }
    ...
    */
    ...
    public boolean equivalentTo(final Fitness _fitness)
        {
        return ((RefactorFitness)_fitness).fitness() == fitness();
        }
